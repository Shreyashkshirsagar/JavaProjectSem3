...
class Gamee extends JFrame{
    ...
    public void setup(){
        image_rock =  new ImageIcon(new ImageIcon("G:\\Shreyash Kshirsagar\\TE-IT\\Java Project\\ProjectPhotoStone\\rock.png").getImage()
                .getScaledInstance(80,80,Image.SCALE_DEFAULT));
        image_paper = new ImageIcon(new ImageIcon("G:\\Shreyash Kshirsagar\\TE-IT\\Java Project\\ProjectPhotoPaper\\paper.png").getImage()
                .getScaledInstance(80,80,Image.SCALE_DEFAULT));
        image_scissor = new ImageIcon(new ImageIcon("G:\\Shreyash Kshirsagar\\TE-IT\\Java Project\\ProjectPhotoScissor\\scissor.png").getImage()
                .getScaledInstance(80,80,Image.SCALE_DEFAULT));
